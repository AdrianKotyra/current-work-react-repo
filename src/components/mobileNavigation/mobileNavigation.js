...
function AddFriendTabMobile({setMessage, setmodalWindowSearch, items, setOpenTab, openTabHandler, userPassword, userEmail, setItems, openTab, onAddFriendName , name, image, balance, onLoader, userLoggedDetails }) {
    ...
    return <><form className='form-add-friend' onSubmit={handleAddItems}>
...
export default function MobileNavigation({onAddFriend, onAddfriendImage, setShowMobileDrop, showMobileDrop, setMessage, setmodalWindowSearch, items, setOpenTab, openTabHandler, userPassword, userEmail, setItems, openTab, onAddFriendName , name, image, balance, onLoader, userLoggedDetails  }){

    return <div className='mobile-navigation-container'>
        <div id="menuToggle" >
            <input id="checkbox" type="checkbox"></input>
            <label onClick={()=>setShowMobileDrop(!showMobileDrop)} class="toggle" for="checkbox">
        ...
        {showMobileDrop&& <div className='mobile-nav-background-container'>
            ...
            <AddFriendTabMobile setMessage={setMessage}
